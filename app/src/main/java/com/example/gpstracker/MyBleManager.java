...
import static com.example.gpstracker.BluetoothLeService.ACTION_DATA_AVAILABLE;

public class MyBleManager extends Service {
    private final static String TAG = MyBleManager.class.getSimpleName();

    final static UUID SERVICE_UUID = UUID.fromString("3076b0b4-6e45-4fec-98f6-b57848224a2e");
    ...
    public void enableNotification()
    {
    	...
    	if (mBluetoothGatt == null) {
    		...
    		*/
        BluetoothGattService GPSService = mBluetoothGatt.getService(UUID_GPS_SERVICE);
        BluetoothGattCharacteristic gpsChara = GPSService.getCharacteristic(UUID_GPS_CHAR);
        mBluetoothGatt.setCharacteristicNotification(gpsChara,true);
//        BluetoothGattDescriptor descriptor = gpsChara.getDescriptor()
